...
addGlobalStyle('#button-dj-play.button-dj, #button-dj-play.button-dj {background-image: url("http://i.imgur.com/SuZmhjh.png")!important;}');//join DJ button
...
var styles = [
            ...
            '#dj-console, #dj-console {background-image: url(http://i.imgur.com/SzjUPtj.gif);min-height:33px;min-width:145px;}',
...
log("Zadejte '/commands' Pro zobrazení speciálních příkázů");
